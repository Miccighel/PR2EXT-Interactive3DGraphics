        ...
        if(intersects.length>0) {
            ...
            switch(chart['type']){
                case 'pieChart':
                    ...
                    valueLabelGeometry = new THREE.TextGeometry( valueLabelText, {size: 1,height: 0.1,curveSegments:2,font: "helvetiker"});
                ...
                case 'barChart':
                    ...
                    valueLabel = new THREE.Mesh( valueLabelGeometry, valueLabelMaterial );
                    chart.add(valueLabel);
                    valueLabel.position.y = 0.5 + 1/(2*chart['value']);
...
function showPieChart() {   
    ...
    chartMesh = generatePieChart(data,visuals,1);
    scene.add(chartMesh);
