...
function generateLights(rows,columns,maxValue,color,lightPower) {
    ...
    spotLight1 = new THREE.SpotLight(color,lightPower,0.0,Math.PI/3,40.0);
    spotLight1.castShadow = true;
    spotLight1.shadowDarkness = 0.3;
    spotLight1.position.set(rows,(maxValue),columns + 40.0);
    ...
    spotLight3.position.set(rows+40.0,(maxValue)/2,columns);
